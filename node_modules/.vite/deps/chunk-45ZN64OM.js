...
var Facet = class {
  ...
  */
  static define(config = {}) {
    return new Facet(config.combine || ((a) => a), config.compareInput || ((a, b) => a === b), config.compare || (!config.combine ? sameArray2 : (a, b) => a === b), !!config.static, config.enables);
  }
  /**
...
//# sourceMappingURL=chunk-45ZN64OM.js.map
